...
document.querySelector("#image9").classList.add("gem");
document.querySelector("#image10").classList.add("gem");
document.querySelector("#image11").classList.add("gem");
...
function nextImage() {
    ...
    //if conditions that make sure the curimg value and newimg value stays in the range 1-11.
    if (curImg < 11) {
        console.log("if current is less than 11, new is current + 1");
        //gives newimg a value that is 1 more than current
        newImg = curImg + 1;
    }

    if (curImg == 11) {
        console.log("if current is 11, new is 1");
        newImg = 1;
    }
    if (curImg > 11) {
        console.log("if current is more than 11, current is 1");
        curImg = 1;
    }
    if (curImg == 0) {
        console.log("if current is 0, current is 11");
        curImg = 11;
    }
...
function prevImage() {
    ...
    if (curImg == 1) {
        console.log("if current is 1, new is 11");
        newImg = 11;
    }
    ...
    if (curImg > 11) {
        console.log("if curent is more than 11, current is 1");
        curImg = 1;
    }
